    ...
    <div className=" flex flex-col max-w-screen-md mx-auto my-6 min-h-[70vh]">
      ...
      <div className=" mx-auto mt-10">
        <div className=" flex flex-row items-center relative">
          <span className=" text-[#222222] text-2xl sm:text-6xl md:text-8xl font-semibold">
          ₹
          </span>
          <input
            type="text"
            ...
            className="bg-gray-200 text-black rounded-lg p-3 text-2xl sm:text-6xl md:text-8xl font-semibold focus:outline-none placeholder-gray-200 max-w-[308px] mx-auto"
            onFocus={handleEdit}
            onBlur={handleEdit}
          />
          {showEdit && (
